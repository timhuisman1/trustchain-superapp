...
class BenchmarkFragment : BaseFragment(R.layout.fragment_benchmark) {
    ...
    fun singleTokenBenchmark(): Long {

        val executionTime = measureTimeMillis {
            transactionEngine.sendTokenSingle(transactionEngine.tokenStore.getSingleToken(), transactionEngine.getSelectedPeer())
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.singleTokenButton.setOnClickListener{
            binding.singleTokenText.text = "${singleTokenBenchmark()} ms"
